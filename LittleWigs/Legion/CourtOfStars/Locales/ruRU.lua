...
if L then
	...
	L.InfernalTome = "Инфернальный фолиант: -10% входящего урона"
	L.MagicalLantern = "Магический светильник: +10% к урону"
	L.NightshadeRefreshments = "Закуски ночной тени: +25% максимального здоровья"
	L.StarlightRoseBrew = "Отвар из звездной розы: Восстанавливает 3% здоровья и 2% маны раз в 3 секунды"
	L.UmbralBloom = "Теневой цветок: +10% Скорости"
	L.WaterloggedScroll = "Промокший свиток: +30% Скорости передвижения"
	L.BazaarGoods = "Рыночные товары: мини-босс"
	L.LifesizedNightborneStatue = "Статуя ночнорожденного в натуральную величину: мини-босс"
	L.DiscardedJunk = "Выброшенный хлам: мини-босс"
	L.WoundedNightborneCivilian = "Раненый ночнорожденный: мини-босс"
	L.FelOrb = "Сфера скверны: +10% крит"
	L.ArcanePowerConduit = "Проводник магической энергии: отключение големов"
	L.FlaskoftheSolemnNight = "Настой священной ночи: убийство босса на 25% здоровья"
