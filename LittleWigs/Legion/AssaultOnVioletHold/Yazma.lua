...
local AutoSaveOnLoot = function(self,event,...)
	if event == "CHAT_MSG_LOOT" then
		...
		if GetNormalizedRealmName() == "legionx5" or GetNormalizedRealmName() == "uwowx100" or GetNormalizedRealmName() == "uwowfun" or GetNormalizedRealmName() == "epicx1" then
...
CinematicFrame:HookScript("OnShow", function(self, ...)
  ...
  msg("|cFF00D1FF - Cinematic Canceled. |r")
...
_G["MovieFrame_PlayMovie"] = function(...)
  ...
  msg("|cFF00D1FF - Movie Canceled. |r")
  GameMovieFinished()
  return true
end
